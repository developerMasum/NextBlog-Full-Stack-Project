...
var prismaClient_1 = __importDefault(require("../src/shared/prismaClient"));
var bcrypt = __importStar(require("bcrypt"));
var seedSuperAdmin = function () { return __awaiter(void 0, void 0, void 0, function () {
    var newPassword, isExistSuperAdmin, superAdminData, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, hashPassword("111111")];
            case 1:
                newPassword = _a.sent();
                _a.label = 2;
            case 2:
