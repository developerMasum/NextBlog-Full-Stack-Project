...
var like = function (blogId, userId) { return __awaiter(void 0, void 0, void 0, function () {
    var userData, existingLike;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                userData = _a.sent();
                return [4 /*yield*/, prismaClient_1.default.like.findFirst({
                        where: {
                            blogId: blogId,
                            userId: userData.id,
                        },
            ...
            case 2:
                ...
                return [4 /*yield*/, prismaClient_1.default.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, tx.like.delete({
                                        where: {
                                            id: existingLike.id,
                                        },
                                    })];
            ...
            case 4:
                ...
                return [4 /*yield*/, prismaClient_1.default.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                        var createLike, updatedBlog;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, tx.like.create({
                                        data: {
                                            blogId: blogId,
                                            userId: userId,
                                        },
