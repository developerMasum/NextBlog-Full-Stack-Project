...
var moderator_constant_1 = require("./moderator.constant");
var getAllModeratorFomDB = function (queryParams, paginationAndSortingQueryParams) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                //@ searching
                if (q) {
                    searchConditions = moderator_constant_1.moderatorSearchableFields.map(function (field) {
                        var _a;
                        return (_a = {},
                ...
                return [4 /*yield*/, prismaClient_1.default.moderator.findMany({
...
var getSingleModeratorFromDB = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prismaClient_1.default.moderator.findUniqueOrThrow({
                    where: {
                        id: id,
                        isDeleted: false,
                    },
...
var updateModeratorIntoDB = function (id, data) { return __awaiter(void 0, void 0, void 0, function () {
    var moderatorData, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prismaClient_1.default.moderator.findUniqueOrThrow({
                    where: {
            ...
            case 5: return [4 /*yield*/, prismaClient_1.default.$transaction(function (tx) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, tx.moderator.update({
                                    where: {
                                        id: id,
                                    },
                                    data: data,
                            ...
                            case 1:
                                ...
                                if (!data.profilePhoto) return [3 /*break*/, 3];
...
var deleteModeratorFromDB = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prismaClient_1.default.moderator.findUniqueOrThrow({
                    where: {
            ...
            case 1:
                ...
                return [4 /*yield*/, prismaClient_1.default.$transaction(function (trClient) { return __awaiter(void 0, void 0, void 0, function () {
                        var deletedModerator;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, trClient.moderator.delete({
                                        where: {
                                            id: id,
                                        },
                                    })];
                                case 1:
                                    deletedModerator = _a.sent();
                                ...
                                case 2:
                                    _a.sent();
                                    return [2 /*return*/, deletedModerator];
                            }
                        });
                    }); })];
...
var softDeleteModeratorFromDB = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prismaClient_1.default.moderator.findUniqueOrThrow({
                    where: {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, prismaClient_1.default.$transaction(function (trClient) { return __awaiter(void 0, void 0, void 0, function () {
                        var ModeratorDeletedData;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, trClient.moderator.update({
                                        where: {
                                            id: id,
                                        },
                                        data: {
                                ...
                                case 2:
                                    _a.sent();
                                    return [2 /*return*/, ModeratorDeletedData];
                            }
                        });
                    }); })];
            case 2: return [2 /*return*/, _a.sent()];
...
exports.ModeratorService = {
    getAllModeratorFomDB: getAllModeratorFomDB,
    getSingleModeratorFromDB: getSingleModeratorFromDB,
    updateModeratorIntoDB: updateModeratorIntoDB,
    deleteModeratorFromDB: deleteModeratorFromDB,
    softDeleteModeratorFromDB: softDeleteModeratorFromDB,
};
